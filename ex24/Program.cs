...
for (int numero = -1; numero != 0;) //inicializa com um valor diferente de zero
{
    Console.Write("Digite um número ( 0 para sair)");
    numero = Convert.ToInt32(Console.ReadLine());

    if (numero != 0) //adicionaa soma apenas a um valr diferete do zero
    {
        soma += numero; //add o num a soma
    }
